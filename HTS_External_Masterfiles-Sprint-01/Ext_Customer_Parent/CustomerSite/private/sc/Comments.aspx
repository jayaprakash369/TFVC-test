<%@ Page Title="Comments" Language="C#" MasterPageFile="~/Scantron_Body_A_Bar.master" AutoEventWireup="true" CodeFile="Comments.aspx.cs" Inherits="private_sc_Comments" %>
<%--
--%>             
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnGeneral" runat="server">
                            <p><asp:Label ID="lbGeneral" runat="server" Text="General Comments" SkinID="labelTitleColor1_Medium" /></p>
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnDelivery" runat="server" Visible="false">
                            <p><asp:Label ID="lbDelivery" runat="server" Text="Service Delivery" SkinID="labelTitleColor1_Medium" /></p>
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnLogistics" runat="server" Visible="false">
                            <p><asp:Label ID="lbLogistics" runat="server" Text="Service Logistics" SkinID="labelTitleColor1_Medium"  /></p>
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnUtilities" runat="server" Visible="false">
                            <p><asp:Label ID="lbUtilities" runat="server" Text="ServiceCOMMAND® Utilities" SkinID="labelTitleColor1_Medium" /></p>
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnAccounting" runat="server" Visible="false">
                            <p><asp:Label ID="lbAccounting" runat="server" Text="Accounting / Invoicing" SkinID="labelTitleColor1_Medium" /></p>
                ...
                <tr>
                    <td colspan="2" align="left">
                        <asp:Panel ID="pnProducts" runat="server" Visible="false">
                            <p><asp:Label ID="lbProducts" runat="server" Text="Service Offerings" SkinID="labelTitleColor1_Medium" /></p>
