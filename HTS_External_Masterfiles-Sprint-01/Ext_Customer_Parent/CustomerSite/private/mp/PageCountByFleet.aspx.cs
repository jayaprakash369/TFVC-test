...
public partial class private_mp_PageCountByFleet : MyPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (sDevTestLive == "LIVE")
            dataTable = wsLiveMps.getPageCountsForOneCustomer(iPrimaryCs1, sAgr, iStart, iEnd);
        else
            dataTable = wsTestMps.getPageCountsForOneCustomer(iPrimaryCs1, sAgr, iStart, iEnd);
