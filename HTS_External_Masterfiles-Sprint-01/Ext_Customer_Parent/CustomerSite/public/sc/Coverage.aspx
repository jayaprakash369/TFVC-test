<%@ Page Title="STS Maintenance Coverage" Language="C#" MasterPageFile="~/Scantron_Body_A_Bar.master" AutoEventWireup="true" CodeFile="Coverage.aspx.cs" 
    Inherits="public_sc_Coverage" %>
    ...
    <asp:Repeater ID="rpCoverage" runat="server" Visible="false">
        <HeaderTemplate>
            <table class="tableWithLines" style="width: 100%">
                <tr>
                    <th>City</th><th>State</th><th>Zip</th><th>Coverage</th><th>Zone</th>
                </tr>
        </HeaderTemplate>
        <ItemTemplate>
            <tr class="trColorReg">
                ...
                <td><center><asp:Label ID="lbZone" runat="server" Text='<%# Eval("Zone") %>' /></center></td>
            </tr>
        </ItemTemplate>
