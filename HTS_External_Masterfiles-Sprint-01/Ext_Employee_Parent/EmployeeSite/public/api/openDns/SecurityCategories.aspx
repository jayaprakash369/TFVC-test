<%@ Page Title="OpenDns: Security Categories" Language="C#" MasterPageFile="~/MasterParent.master" AutoEventWireup="true" CodeFile="SecurityCategories.aspx.cs" 
    Inherits="public_api_openDns_SecurityCategories" %>
<%--
--%>             

<asp:Content ID="Content1" ContentPlaceHolderID="BodyTitle" Runat="Server">
OpenDns: Security Categories
</asp:Content>
    ...
    <div style="clear: both; height: 20px;" ></div>
        ...
        <tr style="vertical-align:top">
            <td>
                ...
                <asp:Label ID="lbCbxlHelp" runat="server" Text="Limit Results To..." SkinID="LabelError1" />
