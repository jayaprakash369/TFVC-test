...
public partial class private_sc_Comments : MyPage
{
    // ---------------------------------------
    // GLOBAL VARIABLES
    // ---------------------------------------
    ...
    protected void btSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (sValid == "VALID")
        {
            ...
            try
            {
                ...
                {
                    sPrimaryCustomerName = ws_Get_B1CustomerName(iPrimaryCustomer.ToString(), "");
                }
                ...
                // Don't use the username as the "from" address because the STS people like to reply all
                //if (!String.IsNullOrEmpty(sUserName))
                //    sEmailFrom = sUserName;
                //else
...
//                }
            ...
            {
                string sErrValues = "Cs1: " + iPrimaryCustomer.ToString() + " Name: " + sPrimaryCustomerName;
