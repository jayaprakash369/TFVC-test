<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SynnexCoverage.aspx.cs" 
    Inherits="public_sc_SynnexCoverage" %>
<%--  --%>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Synnex Maintenance Coverage</title>
        <style type="text/css">
            body {
        ...
        <div>
            <div style="width: 100%; border-bottom: 1px solid #CCCCCC;">
                <div style="padding-left: 40px; padding-top: 1px; padding-right: 40px; padding-bottom: 1px; ">
                    <asp:HyperLink ID="hlSynnex" runat="server" ImageUrl="~/media/images/SynnexLogo.jpg" NavigateUrl="https://www.synnexcorp.com" />
                </div>
            </div>
